...
public class RestaurantsResults {
    ...
    @Expose
    private List<RestaurantPhoto> photos = null;
    @SerializedName("place_id")
    @Expose
    private String placeId;
    @SerializedName("plus_code")
    @Expose
    private RestaurantPlusCode plusCode;
    ...
    public RestaurantPlusCode getPlusCode() {
        return plusCode;
    }

    public void setPlusCode(RestaurantPlusCode plusCode) {
